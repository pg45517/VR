...
class L3Switch(app_manager.RyuApp):
    ...
    def port_desc_stats_reply_handler(self, ev):
        ...
        self.logger.info(self.L3_mac_to_port[dpid])
    ...
    def _packet_in_handler(self, ev):
        ...
        if eth.ethertype == ether_types.ETH_TYPE_IP:
            ...
            elif dst_ip in interface_ip_to_mac:
            ...
            if ipaddress.ip_address(dst_ip) in ipaddress.ip_network(net):
                for router_ip in interface_ip_to_mac:
                    if ipaddress.ip_address(router_ip) in ipaddress.ip_network(net):
                        ...
                        self.send_arp(datapath, 1, router_ip, interface_ip_to_mac[router_ip], dst_ip, 'FF:FF:FF:FF:FF:FF', self.L3_mac_to_port[dpid][interface_ip_to_mac[router_ip]])
